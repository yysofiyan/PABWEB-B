    ...
    ?>
        ...
        <table class="table table-striped table-bordered">
            ...
            if (isset($cari)) {
                ...
                $query = mysqli_query($db, "SELECT count(nis) as jumlah FROM tbl_siswa")
                                            or die('Ada kesalahan pada query siswa: '.mysqli_error($db));
            }
            ...
            while ($data = mysqli_fetch_assoc($query)) { ?>
                <tr>
                    ...
                    <td width="200"><?php echo $data['tempat_lahir']; ?>, <?php echo date('d-m-Y',
                    ...
                    <td>
                        <a title="Ubah" class="button-ubah btn btn-outline-info" 
                        ...
                        onclick="return confirm('Anda yakin ingin menghapus siswa 
                        <?php echo $data['nama']; ?>?');"><i class="fas fa-trash"></i></a>
                    </td>
                </tr>
            <?php
                $no++;
