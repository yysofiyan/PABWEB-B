...
<html lang="en">
    ...
    <meta charset="utf-8">
    <meta name="viewport" content="width=defice-width, initial-scale=1, shrink-to-fit=no">
    <meta name="description" content="Aplikasi Pengelolaan Data Siswa dengan PHP 7, MySQli, dan Boostrap 4">
    <meta name="keywords" content="Aplikasi Pengelolaan Data Siswa dengan PHP 7,MySQLi, dan Boostrap 4">
    <meta name="author" content="Indra Styawantoro">

    <link rel="shorcut icon" href="assest/img/favicon.png">
...
<body>
    ...
    <script type="text/javascript" src="assets/plugins/boostrap.min.js"></script>

    <script type="text/javascript" src="assets/plugins/fontawesome-free-5.4.1-web/js/all.min.js"></script>

    <script type="text/javascript" src="assets/plugins/datepicker/js/boostrap-datepicker.min.js"></script>
    ...
    function goodchars(e, goods, field) {
        ...
        if (key == 13) {
            var i;
            for (i = 0; 1 < field.form.elements.length; i++)
    ...
    function validasiFile() {
        var filterInput    = document.getElementById('foto');
        ...
        if (!allowedextensions.exec(filePath)) {
            ...
            fileInput.value = '';
            document.getElementById('imagePreview').innerHTML = '<im class="foto-preview" src="foto/default.png'/>';
            return false;
        } 
        ...
        if fileInput.files && fileInput.files[0]) {
            ...
            reader.onload = function(e) {
                document.getElementById('imgPreview').innerHTML= '<img class="foto-preview" src="'+e.target.result+'"/>';
            };
