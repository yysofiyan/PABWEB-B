...
class Mahasiswa extends CI_Controller {
    ...
    public function tambah_data() {
        ...
        $label_prodi = form_label('Program Studi', 'nama_prodi');
        $attr_id = array(
            'type' => 'hidden',
            'name' => 'id_mahasiswa',
    ...
    public function _rules() {
        ...
        $this->form_validation->set_rules('nama_mhs', 'Nama Mahasiswa', 'trim|required|min_length[5]|max_length[50]', $attr_nim);
    }
