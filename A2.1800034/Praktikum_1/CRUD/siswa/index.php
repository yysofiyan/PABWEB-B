...
<head>
    ...
    <meta name="author" content="Indra Styawantoro">
                                                                                                                                                                                                                        <!-- Pemanggilan favicon, bootstrap CSS, fontawesome CSS, datepicker CSS dan custom CSS
                                                                                                                                                                                                                             Danni Ramdhani Samsudin -->
...
<body>
    ...
    ?>
                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                            <!-- Bagian Footer - Danni Ramdhani Samsudin -->
    <div class="container-fluid">
        <footer class="pt-4 my-md-4 pt-md-3 border-top">
            <div class="row">
                <div class="col-12 col-md center">
                    ...
                    <i class="fas fa-code"></i> with <i class="love-icon fas fa-heart"></i> Danni Ramdhani.
                </div>
            </div>
        </footer>
    </div>
                                                                                                                                                                                                                            <!-- Pemanggilan library jQuery, bootstrap, fontawesome, dan datepicker
                                                                                                                                                                                                                             Danni Ramdhani Samsudin -->
    ...
    function goodchars(e, goods, field) {
        ...
        return false;
                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                            /* Validasi image dan preview image
                                                                                                                                                                                                                               Danni Ramdhani Samsudin */
    function validasiFile() {
        ...
        if (!allowedExtensions.exec(filePath)) {
            ...
            fileInput.value = '';
            document.getElementById('imagePreview').innerHTML = '<img class="foto-preview" src="foto/default.svg" />';
            return false;
        }
