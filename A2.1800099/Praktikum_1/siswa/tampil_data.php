...
<div class="row">
   ...
   <?php
      ...
      // jika alert = 2
    // tampilkan pesan Sukses "Data siswa berhasil dirubah"
    elseif ($_GET['alert'] == 2) { ?>
        <div class="alert alert-success alert-dismissible fade show" role="alert">
   ...
   <?php
    ...
    ?>
        ...
        <table class="table table-striped table-bordered"> 
            ...
            if (isset($cari)) {
                $query  = mysqli_query($db, "SELECT * FROM tbl_siswa 
                                        ...
                                        or die('Ada kesalahan pada query siswa:'.mysql_error($db));
            }  
            else {
        ...
        <nav aria-label="Page navigation exmaple">
            ...
            if ($halaman_aktif<='1') { ?>
                <li class="page-item disable"> <span class="page-link">Sebelumnya</span></li>
             <?php 
            }
           ...
           <?php
            ...
            <?php
            // jika halaman aktif >= jumlah halaman, maka button sekanjutnya = disable
            if ($halaman_aktif>=$halaman) { ?>
                <li class="page-item disable"> <span class="page-link">Selanjutnya</span></li>
            <?php
            }
            // jika halaman aktif <= jumlah halaman, maka button selanjutny = aktif
            else { ?>
                <li class="page-item"><a class="page-link"
