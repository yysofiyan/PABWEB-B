...
<body>
    <div class="container-fluid">
        <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
            <h5 class="my-0 mr-md-auto font-weight-normal"><i class="fas fa-user title-icon"></i><a href="https://repo-rizalf.000webhostapp.com/siswa/">Data Siswa</a></h5>
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        function validasiFile() {
            ...
            if (!allowedExtensions.exec(filePath)) {
                ...
                fileInput.value = '';
                document.getElementById('imagePreview').innerHTML = '<img class="foto-preview" src="assets/img/foto/default.png"/>';
                return false;
            }
