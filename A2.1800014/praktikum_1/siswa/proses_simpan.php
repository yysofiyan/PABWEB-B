...
if (isset($_POST['simpan'])) {
	...
	// jika nis belum ada
		...
		if (move_uploaded_file($tmp_file, $path)) {
			...
			$insert = mysqli_query($db, "INSERT INTO tbl_siswa(nis,nama,tempat_lahir,tgl_lahir,jenis_kelamin,agama,alamat,no_hp,foto) VALUES('$nis','$nama','$tempat_lahir','$tanggal_lahir','$jenis_kelamin','$agama','$alamat','$no_hp','$nama_file')") or die('Ada kesalahan pada query insert : '.mysqli_error($db));
			// cek query
			if ($insert) {
