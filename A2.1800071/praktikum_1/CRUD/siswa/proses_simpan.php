...
if (isset($_POST['simpan'])) {
    ...
    $path = "foto/".$nama_file;
    //Jajang Jamaludin
    $query = mysqli_query($db, "SELECT nis FROM tbl_siswa1 WHERE nis='$nis'")
    ...
    if ($rows > 0) {
        ...
        if (move_uploaded_file($tmp_file, $path)) {
            $insert = mysqli_query($db, "INSERT INTO tbl_siswa1(nis,nama,tempat_lahir,tanggal_lahir,jenis_kelamin,agama,alamat,no_hp,foto)
