    ...
    class Mahasiswa extends CI_Controller
    {
        ...
        public function _rules()
        {
            ...
            $attr_nama = array(
                ...
                'min_length' => 'Nama mahasiswa niminal 5 karakter!',
        ...
        public function edit($id) {       
            ...
            if ($get_row->num_rows() > 0) {
                ...
                $input_nama = form_input('namah_mhs', $nama_mhs);
                ...
                public function edit_aksi()
                {
                    ...
                    $this->Mahsiswa_model->update_data($id, $data);
                    $this->session->set_flashdata('pesan', 'data baerhasil diubah');
                    redirect('mahasiswa');
                    }
                }
