...
<html lang="en">
 <head>
    ...
    <meta name="author" content="Sinta Manah">
...
<script type="text/javascript" src="assets/plugins/datepicker/js/'bootstrap-datapicker.min.js"></script>
...
(function() {
   ...
   window.addEventListener('load', funtion() {
      ...
      var forms = document.getElementsByClassName('needs-validaton');
