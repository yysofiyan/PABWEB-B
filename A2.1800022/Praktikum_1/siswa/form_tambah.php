					...
					<div class="row">
						...
						<div class="col">
							<div class="form-group col-md-12">
								...
								<input type="text" class="form-control" name="tempat lahir"autocomplete="off" required>
							...
							<div class="form-group col-md-12">
								<label>Alamat</label>
								<textarea type="text" class="form-control" rows="2" name="alamat"autocomplete="off" required></textarea>
