...
<meta name="description" content="Aplikasi pengelolaan data siswa dengan PHP 7, MYSQLI, dan bootsrap 4">
<meta name="keywords" content="Aplikasi pengelolaan data siswa dengan PHP 7, MYSQLI, dan bootsrap 4">
...
<div class="row">
<div class="col-12 col-md center"><a>Rismaya Siti Mukarromah ❤</a>
...
if (!allowedExtensions.exec(filePath))
 { 
    alert('Tipe file foto tidak sesuai. Harap unggah file foto yang memiliki tipe *.jpg atau*.png');fileInput.value = ''; document.getElementById('imagePreview').innerHTML = '<img class="foto-preview" src="foto/default.png"/>';
return false;
}
...
// selain itu
    ...
    // Image preview
if (fileInput.files && fileInput.files[0]) { var reader = new FileReader(); reader.onload = function(e) {
