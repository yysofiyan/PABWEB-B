		...
		<?php
			...
			if (empty($_GET['alert'])) {
			 ...
			 ?>
			 	...
			 	<!-- Tabel siswa untuk menampilka data siswa dari database -->
			 		...
			 		<tbody>
			 			<?php 
			 				...
			 				// jika tidak dilakukan pencarian data
			 					...
			 					// data yang ditampilkan mulai = $mulai sampai dengan batas = $batas
			 					$query = mysqli_query($db, "SELECT * FROM tbl_siswa ORDER BY nis DESC LIMIT $mulai, $batas") or die('Ada kesalahan pada query siswa: '.mysql_error($db));
			 				}
			 				// tampilkan data
			 				while ($data = mysqli_fetch_assoc($query)) { ?>
			 					<tr>
			 						<td width="30" class="center"><?php echo $no; ?></td>
			 						<td width="45"><img class="foto-thumbnail" src='foto/<?php echo $data['foto']; ?>' alt="Foto Siswa" width="100"></img></td>
			 						...
			 						<td width="120" class="center">
			 							...
			 							<a title="Hapus" class="btn btn-outline-danger" href="proses_hapus.php?nis=<?= $data['nis'] ?>" onclick="return confirm('Yakin hapus?')"><i class="fas fa-trash"></i></a>
			 						</td>
			 					</tr>
			 				<?php 
			 					$no++;
			 	...
			 	<?php 
			 		// fungsi untuk pengecekkan halaman aktif
			 				...
			 				<ul class="pagination justify-content-end">
			 					...
			 					<?php 
									...
									//  jika halaman aktif > 1, maka button Sebelumnya = aktif
										...
										<li class="page-item"><a href="?hal=<?php echo $page -1 ?>" class="page-link">Sebelumnya</a></li>
									<?php } ?>
									...
									// jika halaman aktif <= jumlah halaman, maka button Selanjutnya = aktif
										...
										<li class="page-item"><a href="?hal=<?php echo $page +1 ?>" class="page-link">Selanjutnya</a></li>	
									<?php } ?>
			 				</ul>
			 			</nav>
			 		</div>
