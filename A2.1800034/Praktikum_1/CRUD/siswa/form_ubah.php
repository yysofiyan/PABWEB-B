                ...
                enctype="multipart/form-data" novalidate>
                    <div class="row">
                        <div class="col">
                            ...
                            if ($jenis_kelamin=='Laki-laki') { ?>
                                ...
                                <div class="custom-control custom-radio mb-4">
                                    ...
                                    id="customControlValidation3" value="Perempuan" required>
                            ...
                            <?php 
                                ...
                                <div class="custom-control custom-radio">
                                    <input type="radio" class="custom-control-input" name="jenis_kelamin" 
                                    id="customControlValidation2" value="Laki-laki" required>
                                    <label class="custom-control-label" for="customControlValidation2">Laki-laki</label>
                                </div>
                                <div class="custom-control custom-radio mb-4">
                                    <input type="radio" class="custom-control-input" name="jenis_kelamin" 
                                    id="customControlValidation3" value="Perempuan" checked required>
                                    <label class="custom-control-label" for="customControlValidation3">Perempuan</label>
                                    <div class="invalid-feedback">Pilih salah satu jenis kelamin.</div>
                                </div>
                            <?php } ?>
                        ...
                        <div class="col">
                            ...
                            <div class="tgl-lahir form-group col-md-12">
                                <label>Tanggal Lahir</label>
                                <input type="text" class="form-control date_picker" data-date-format="dd-mm-yyyy" 
                    ...
                    <div class="button-simtal form-group col-md-12 right">
                        <input type="submit" class="btn btn-info btn-submit mr-2" name="simpan" id="Simpan" value="Simpan">
