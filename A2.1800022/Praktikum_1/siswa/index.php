...
<html lang="en">
    ...
    <head>
        ...
        <meta name="author" content="apip febriansyah">
    ...
    <body>
        ...
        <br>
            ...
            border-bottom shadow">
                <h4 class="my-0 mr-md-auto font-weight-bold"><i class="fas fa-user title-icon"></i> SISWA</h4>
            </div>
        </div>
            ...
            <footer class="pt-4 my-md-4 pt-md-3 border-top">
                <div class="row">
                    <div class="col-12 col-md center">
                        &copy; 03-04-2020 - <a class="text-info" href="https://stmik-sumedang.ac.id/">STMIK Sumedang </a>
                    </div>
                </div>
            </footer>
        </div>
